...
def D_Rag():
    WORKING_DIR = "level1_T2_70B"
    done_records_path = 'DRAG_T2_70B_done_records.csv'  
    ...
    for drug in tqdm(df['Drug Effectiveness Assessment_Closest'], desc="LightRAG indexing"):
