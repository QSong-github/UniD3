...
def D_Rag():
    WORKING_DIR = "level2_T3_70B"
    nodes_file = '/UniD3/tool/DRAG_T3_70B_output/filtered_nodes_l1.csv'
    edges_file = '/UniD3/tool/DRAG_T3_70B_output/filtered_edges_l1.csv'
    output_file = '/UniD3/tool/DRAG_T3_70B_output/contents.csv'
    processed_ids_file = "/UniD3/tool/DRAG_T3_70B_output/processed_ids.csv"
